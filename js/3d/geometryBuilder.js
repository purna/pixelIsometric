...
class GeometryBuilder {
    ...
    /**
     * Creates a simple flat triangle plane (NCTM style).
     */
    static createTrianglePlane(options) {
        options = options || {};
        ...
        this.generatePlanarUV(geometry, 1);
        return geometry;
    }

    /**
     * Creates a thin line-like box geometry for edge highlighting.
     */
